...
namespace Aiub_Blood_Bank
{
    public partial class AddPatient : Form
    {
        string name;
        int id;
        public AddPatient(string _name = "Profile", int id=0)
        {
            InitializeComponent();
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "INSERT INTO patient (name, mobile, dob, gender, bg, address) VALUES (@name, @mobile, @dob, @gender, @bg, @address)";
                ...
                MessageBox.Show("New Patient Added Succesfully!!");
                nameTextBox.Text = "";
                mobileTextBox.Text = "";
                bgComboBox.Text = "";
                addressTextBox.Text = "";
